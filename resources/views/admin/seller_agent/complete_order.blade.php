    ...
    <div class="card">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link test active" href="{{route('sales/agent/completed_order')}}">Completed <span style="padding: 4px;font-size: 9px; color: #fff; background: #01cc84; border-radius: 16%;">{{$complete_order_count}}</span></a>
                  </li>
                  <li class="nav-item">
                ...
                ->join('users','users.id','=','invoice.buyer_id')
                ->join('comapny','comapny.id','=','invoice.seller_company_id')
               // ->join('agent_assign_company','agent_assign_company.company_id','=','invoice.seller_company_id')
                ->where('invoice.seller_id',auth()->user()->id)
                ...
                <div class="card">
                        ...
                        <div class="card-header text-center">
                          <a style="font-size: 14px;">Status:<span class="btn btn-xs btn-primary" style="font-size: 10px;margin-left: 5px;">Complete</span></a>
                        <a style="padding: 5px;color: #9e9e9e;" href="{{route('sales/agent/view_complete_orders_details',$ord->invoice_id)}}"><i class="fas fa-eye" style="font-size: 16px;"></i></a>
