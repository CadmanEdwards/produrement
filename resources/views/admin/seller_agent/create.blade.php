...
<div class="container" style="border:1px solid #ccc;border-radius: 9px;">
  <div class="container" >
      <h4 style="padding: 14px;">Create Sales Agent</h4>
  </div>
  <form action="{{route('seller/agent/submit')}}" method="POST" enctype="multipart/form-data" enctype="multipart/form-data">
    @csrf
    <div class="row" >
        <div class="col-md-6">
...
<div class="row">
    <div class="col-md-6">
        <label for="asign_area">Assign Area</label>
           ...
           <input type="text" id="area_assign" name="area_assign" style="left:0px !important;" class="form-control" required>
    ...
    <div class="col-md-6">
       ...
       <input type="text" id="discount_percentage" name="discount_percentage"  value="{{ old('discount_percentage', isset($user) ? $user->discount_percentage : '') }}" class="form-control" required>
      ...
      <label>Assign Companies</label>
        <div>
            ...
            <div class="form-check">
                <input class="form-check-input" name="assign_company[]" type="checkbox" value="{{$company->id}}" id="defaultCheck1">
...
<div class="row">
    <div class="container" style="padding: 17px;">
       <input class="btn btn-danger" style="background: #01cc84; border: none; float: right;" type="submit" value="{{ trans('global.save') }}">   </div>
   </div>
...
<script>
  function show_image() 
  {
   ...
   for(var i=0;i<total_file;i++)
   {
    ...
    function initialize() {
      var latlng = new google.maps.LatLng(24.9025,67.0729);
