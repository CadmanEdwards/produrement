...
<div class="row">
    ...
    <div class="card">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                    <a class="nav-link test active"  href="{{ route('sales/agent/order') }}">Pending Orders <span style="padding: 4px;font-size: 9px; color: #fff; background: #01cc84; border-radius: 16%;">{{$pending_order_count}}</span></a>
                  </li>
                  <li class="nav-item">
              ...
              ?>
                ...
                <div class="col-md-6">
                  <div class="card">
                          ...
                          <div class="card-header text-center">
                            <a style="font-size: 14px;">Status:<span class="btn btn-xs btn-primary" style="font-size: 10px;margin-left: 5px;">Pending</span></a>
                          <a style="padding: 5px;color: #9e9e9e;" href="{{route('sales/agent/view/order',$ord->id)}}"><i class="fas fa-eye" style="font-size: 16px;"></i></a>
                        <!--  <a><i class="fa fa-pencil-square-o" style="font-size: 17px; color: #01cc84;"></i></a> -->
