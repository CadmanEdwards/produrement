...
?>
              ...
              <div class="row">
               ...
               <form method="POST" action="{{ route('payment/partial/add/invoice') }}">
               <div class="row">
               ...
               <table class="table table-striped table-bordered">
                    <tbody>
                    <tr>
                    <th colspan="4">Remainig Payment Details</th>
                    </tr>
                      <tr>
                      ...
                      <tr>
                        ...
                        <th colspan="2">
                        <div class="input-group">
                          <input type="number" class="form-control" name="adjustement_amount" value="{{($total_sum_price+$new_width)-$payment->sum('final_amount')}}">
                          <div class="input-group-append">
                            <span class="input-group-text" id="basic-addon2">RS</span>
                          </div>
                        </div>
                      ...
                      <tr>
                        ...
                        <th colspan="2">
                        <div class="input-group">
                          <input type="number" class="form-control" name="cheque_amount" value="{{($total_sum_price+$new_width)-$payment->sum('final_amount')}}">
                          <div class="input-group-append">
                            <span class="input-group-text" id="basic-addon2">RS</span>
                          </div>
                        </div>
                      ...
                      <tr>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" class="form-control" name="final_amount" id="final_amount" value="{{($total_sum_price+$new_width)-$payment->sum('final_amount')}}">
                        </div>
                        </th>
                      </tr>
                    </tbody>
