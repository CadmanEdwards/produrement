    ...
    <div class="card">
            ...
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                <li class="nav-item">
                  ...
                  <li class="nav-item">
                    <a class="nav-link test active" href="{{route('completed_order')}}">Completed <span style="padding: 4px;font-size: 9px; color: #fff; background: #01cc84; border-radius: 16%;">{{$complete_order_count}}</span></a>
                  </li>
                  <li class="nav-item">
                ...
                <div class="card">
                        ...
                        <a style="padding: 5px;color: #9e9e9e;" href="{{route('view/complete/orders',$ord->invoice_id)}}"><i class="fas fa-eye" style="font-size: 16px;"></i></a>
