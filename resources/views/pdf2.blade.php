...
$order_item = DB::table('order_items')
     ->select('order_items.*','product.name as product_name','product.skucode','product.discount_price as price','product.acutal_price as acutal_price','product.images','product.discription')
...
<body style="font-family: system-ui;">
    ...
    ">
    <tr>
    <th  style="float:right;">Total</th><td>RS {{$total_sum_price}}</td></tr>
   <tr> <th style="float:right;">Actual Price</th> <td>RS {{$total_actual_sum_price}}</td></tr>
    <tr><th style="float:right;">Discount Price</th><td>RS {{$total_sum_price}}</td></tr>
   <tr> <th style="float:right;">Discount</th><td>RS {{$total_actual_sum_price - $total_sum_price}}</td></tr>
   <tr> <th style="float:right;">Total Price With GST</th><td>RS {{$order->total_price_with_ST}}</td>
    </tr>
    </table>
    </tr>
    </table>
