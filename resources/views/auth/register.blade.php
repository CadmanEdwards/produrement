...
.btn-success:disabled {
    background-color: #9e9e9e8c !important;
    color: #000 !important;
}
    ...
    <div class="row justify-content-center">
        ...
        <div class="row" style="    margin-bottom: 19px; margin-top: 19px;">
            ...
            <div class="login_heading text-center">
                <h2 style="padding: 10px; border-bottom: 1px solid #ccc; width: 90%; margin: 0 auto;">Sign Up For Seller</h2>
            
                </div>

                <div class="card-body">
                    <form method="POST" action="{{ route('register_seller_submit') }}">
                        @csrf
                        ...
                        <input id="name" type="text" aria-describedby="basic-addon1" style="border-left-color: transparent; height: 43px; background: #f9faff" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ old('name') }}" required autocomplete="name" autofocus >
                        @error('name')
                        ...
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon2" style="background: #f9faff;"><i class="fa fa-envelope" style="color: #9e9e9e;"></i></span>
                                ...
                                <input id="email" type="email" aria-describedby="basic-addon2" style="border-left-color: transparent; height: 43px; background: #f9faff;" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" required autocomplete="email">
                        ...
                        <div class="input-group-prepend">
                            <span class="input-group-text" id="basic-addon3" style="background: #f9faff;"><i class="fas fa-lock" style="color: #9e9e9e;"></i></span>
                                ...
                                <input id="password" aria-describedby="basic-addon3" style="border-left-color: transparent; height: 43px; background: #f9faff;" type="password" class="form-control @error('password') is-invalid @enderror" name="password" required autocomplete="new-password">
                        ...
                        <div class="form-group mb-0">
                                ...
                                <button type="submit" class="btn btn-success btn-block submite_register" style="background-color: #01cc84;color: #fff; border: none; height: 39px;" disabled>
                                    {{ __('Register') }}
                                </button>
