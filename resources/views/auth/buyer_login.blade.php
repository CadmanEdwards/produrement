    ...
    <div class="row justify-content-center">
        ...
        <br/>
            <div class="card" style="border: none;">
                ...
                <h2 style="padding: 10px; border-bottom: 1px solid #ccc; width: 90%; margin: 0 auto;">{{ __('Sign In Buyer') }} </h2>
            ...
            <div style="margin-left: 14px;">
                                    <a href="{{ route('Buyer/forgot_password') }}" style="color: #01cc84;">
                                        {{ __('Forgot Your Password?') }}
                                    </a>
                                    </div>
                                <br/>
                                <br/>
            <p class="text-center" style="color: #9e9e9e;">Don't Have An Account? <a style="color: #01cc84 !important;" href="{{ route('Buyer/register') }}">Sign Up</a></p>
        </div>
    </div>
</div>
@endsection
